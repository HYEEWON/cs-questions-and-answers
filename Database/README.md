...
<details>
<summary style="font-size:20px">트랜잭션</summary>
<div markdown="1">

* 데이터베이스의 상태를 변화시키는 `원자적인/논리적인 작업 단위`
* `100% 적용되거나 아무것도 적용되지 않아야 함`
...
<details>
<summary style="font-size:20px">ACID</summary>
<div markdown="1">
...
<details>
<summary style="font-size:20px">Commit과 Rollback</summary>
<div markdown="1">
...
<details>
<summary style="font-size:20px">SQL</summary>
<div markdown="1">
...
<details>
<summary style="font-size:20px">시퀀스 (오라클)</summary>
<div markdown="1">
...
<details>
<summary style="font-size:20px">인덱스 (Index)</summary>
<div markdown="1">
...
* 큰 테이블을 제거하여 관리가 쉽고, 읽기/쓰기 성능 향상
* 조인 비용 증가, 테이블과 인덱스를 별도로 파티셔닝 할 수 없고 함께 파티셔닝 해야 함 
